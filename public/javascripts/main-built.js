...
define('text!templates/navbar/item_view.html',[],function () { return '<a href="#" data-toggle="collapse" data-target=".nav-collapse"> <%= title %> </a> ';});
...
define('views/navbar/item_view',['backbone', 'text!templates/navbar/item_view.html'], function(Backbone, Template) {
  var NavItemView;
...
define('views/navbar/list_view',['backbone', 'views/navbar/item_view'], function(Backbone, NavItemView) {
  var NavListView;
...
define('text!templates/navbar/index_view.html',[],function () { return '<div class="container">\n  <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse">\n    <span class="icon-bar"></span>\n    <span class="icon-bar"></span>\n    <span class="icon-bar"></span>\n  </a>\n  <a class="brand" href="#"><strong>Top Naujienos</strong></a>\n  <div class="nav-collapse collapse">\n \n  </div>\n</div>';});
...
define('views/navbar/index_view',['backbone', 'views/navbar/list_view', 'text!templates/navbar/index_view.html'], function(Backbone, NavListView, Template) {
  var NavbarShowView;
  return NavbarShowView = (function(_super) {
    ...
    NavbarShowView.prototype.initialize = function(options) {
      ...
      return this.items = options.collection;
    };
    ...
    NavbarShowView.prototype.renderItems = function() {
      ...
      return this.$('.nav-collapse').append(this.navItemsList.render().el);
    };
...
define('views/helper/spinner_view',['spinner', 'backbone'], function(Spinner, Backbone) {
  ...
  return SpinnerView = (function(_super) {
    ...
    SpinnerView.prototype.className = 'spinner';
...
define('text!templates/helper/modal_view.html',[],function () { return '<div class="modal-header">\n  <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>\n  <h3 id=\'myModalLabel\' class="style-<%= title %>"><%= title %><h3>\n</div>\n<div class="modal-body">\n\n</div>\n\n<div class=\'modal-footer\'>\n  <button class=\'btn btn-block btn-info\' data-dismiss=\'modal\' aria-hidden=\'true\'>Uždaryti</button>\n</div>\n';});
...
define('views/helper/modal_view',['views/helper/spinner_view', 'backbone', 'text!templates/helper/modal_view.html'], function(Spinner, Backbone, Template) {
  var ModalView;
  return ModalView = (function(_super) {
    ...
    function ModalView() {
      ...
      this.renderArticle = __bind(this.renderArticle, this);

      this.getArticle = __bind(this.getArticle, this);
    ...
    ModalView.prototype.initialize = function(options) {
      ...
      this.article = new Backbone.Model;
      this.article.on('change', this.renderArticle);
      this.article.urlRoot = "" + (this.title.toLowerCase()) + "-article";
      return this.render();
    };
    ...
    ModalView.prototype.getArticle = function() {
    ...
    ModalView.prototype.renderArticle = function(model, res) {
      this.spinner.remove();
      return this.$('.modal-body').html("" + (model.get('0').article));
    };

    ModalView.prototype.spinner = function() {
      this.spinner = new Spinner({
        shadow: true,
        width: 4
      });
      return this.$('.modal-body').append(this.spinner.el);
    };

    ModalView.prototype.leave = function() {
      var _ref;
...
define('text!templates/news/item_view.html',[],function () { return '<a href="<%= details.address %>" target="_blank"><h1 class="style-<%= details.site %>"><%= details.site %></h1></a>\n<% for(post in posts) { %>\n  <% var article = posts[post] %>\n  <a class="article-address" href="<%= article["url"] %>">\n    <img width="100%" src="<%= article[\'img\'] %>" class="img-rounded" />\n    <h4><%= article["title"] %></h4>\n  </a>\n  <hr>\n<% } %>';});
...
define('views/news/item_view',['views/helper/modal_view', 'backbone', 'text!templates/news/item_view.html'], function(Modal, Backbone, Template) {
  var NevsItemView;
  return NevsItemView = (function(_super) {

    __extends(NevsItemView, _super);

    function NevsItemView() {
      this.getArticleBody = __bind(this.getArticleBody, this);

      this.render = __bind(this.render, this);
      return NevsItemView.__super__.constructor.apply(this, arguments);
    }

    NevsItemView.prototype.className = 'span3';

    NevsItemView.prototype.events = {
      'click .article-address': "getArticleBody"
    };

    NevsItemView.prototype.initialize = function(options) {
      return this.template = _.template(Template);
    };

    NevsItemView.prototype.render = function() {
      var data;
    ...
    NevsItemView.prototype.getArticleBody = function(e) {
      e.preventDefault();
      this.modal = new Modal({
        title: this.details.site,
        url: $(e.currentTarget).attr('href')
      });
      return this.$el.append(this.modal.el);
    };
...
define('views/news/list_view',['views/news/item_view', 'backbone'], function(ItemView, Backbone) {
  var NewsListView;
  return NewsListView = (function(_super) {

    __extends(NewsListView, _super);
    ...
    function NewsListView() {
      ...
      this.render = __bind(this.render, this);
      return NewsListView.__super__.constructor.apply(this, arguments);
    }

    NewsListView.prototype.initialize = function(options) {};
    ...
    NewsListView.prototype.addAll = function() {
      return this.collection.each(this.addOne);
    };

    NewsListView.prototype.addOne = function(model) {
...
define('models/news',['backbone'], function(Backbone) {
  var NewsModel;
  return NewsModel = (function(_super) {

    __extends(NewsModel, _super);

    function NewsModel() {
      return NewsModel.__super__.constructor.apply(this, arguments);
    }

    NewsModel.prototype.urlRoot = '/news';
...
define('collections/news',['models/news', 'backbone'], function(NewsModel, Backbone) {
  var NewsCollection;
  return NewsCollection = (function(_super) {
    ...
    NewsCollection.prototype.model = NewsModel;

    NewsCollection.prototype.url = '/news';
...
define('views/news/index_view',['views/news/list_view', 'collections/news', 'backbone', 'views/helper/spinner_view'], function(NewsListView, News, Backbone, Spinner) {
  var NewsView;
  return NewsView = (function(_super) {

    __extends(NewsView, _super);

    function NewsView() {
      this.renderNews = __bind(this.renderNews, this);

      this.spinner = __bind(this.spinner, this);
      return NewsView.__super__.constructor.apply(this, arguments);
    }

    NewsView.prototype.className = "row";

    NewsView.prototype.initialize = function(options) {
      this.news = new News();
      this.news.on('reset', this.renderNews);
      return this.news.fetch();
    };
    ...
    NewsView.prototype.spinner = function() {
      this.spinner = new Spinner({
        shadow: true,
        width: 4
      });
    ...
    NewsView.prototype.renderNews = function() {
      this.spinner.remove();
...
define('views/fashion/item_view',['views/helper/modal_view', 'backbone', 'text!templates/news/item_view.html'], function(Modal, Backbone, Template) {
  var FashionItemView;
  return FashionItemView = (function(_super) {

    __extends(FashionItemView, _super);

    function FashionItemView() {
      this.getArticleBody = __bind(this.getArticleBody, this);

      this.render = __bind(this.render, this);
      return FashionItemView.__super__.constructor.apply(this, arguments);
    }

    FashionItemView.prototype.className = 'span3';

    FashionItemView.prototype.events = {
      'click .article-address': "getArticleBody"
    };

    FashionItemView.prototype.initialize = function(options) {
      return this.template = _.template(Template);
    };

    FashionItemView.prototype.render = function() {
      var data;
      data = this.model.toJSON();
      this.details = {
        site: data['0']['site'],
    ...
    FashionItemView.prototype.getArticleBody = function(e) {
      e.preventDefault();
      this.modal = new Modal({
        title: this.details.site,
        url: $(e.currentTarget).attr('href')
...
define('views/fashion/list_view',['views/fashion/item_view', 'backbone'], function(ItemView, Backbone) {
  var FashionListView;
  return FashionListView = (function(_super) {

    __extends(FashionListView, _super);

    function FashionListView() {
      this.addOne = __bind(this.addOne, this);

      this.addAll = __bind(this.addAll, this);

      this.render = __bind(this.render, this);
      return FashionListView.__super__.constructor.apply(this, arguments);
    }

    FashionListView.prototype.initialize = function(options) {};

    FashionListView.prototype.render = function() {
      this.$el.html();
      this.addAll();
      return this;
    };

    FashionListView.prototype.addAll = function() {
      return this.collection.each(this.addOne);
    };

    FashionListView.prototype.addOne = function(model) {
      this.itemView = new ItemView({
        model: model
      });
      return this.$el.append(this.itemView.render().el);
...
define('models/fashion',['backbone'], function(Backbone) {
  var Fashion;
  return Fashion = (function(_super) {

    __extends(Fashion, _super);

    function Fashion() {
      return Fashion.__super__.constructor.apply(this, arguments);
    }

    Fashion.prototype.urlRoot = '/fasshion';
...
define('collections/fashions',['models/fashion', 'backbone'], function(Fashion, Backbone) {
  var Fashions;
  return Fashions = (function(_super) {

    __extends(Fashions, _super);

    function Fashions() {
      return Fashions.__super__.constructor.apply(this, arguments);
    }

    Fashions.prototype.model = Fashion;

    Fashions.prototype.url = '/fashion';
...
define('views/fashion/index_view',['views/fashion/list_view', 'collections/fashions', 'backbone', 'views/helper/spinner_view'], function(FashionListView, Fashions, Backbone, Spinner) {
  var NewsView;
  return NewsView = (function(_super) {
    ...
    NewsView.prototype.initialize = function(options) {
      this.fashions = new Fashions();
      this.fashions.on('reset', this.renderNews);
      return this.fashions.fetch();
    };
    ...
    NewsView.prototype.renderNews = function() {
      this.spinner.remove();
      this.listView = new FashionListView({
        collection: this.fashions
      });
      return this.$el.append(this.listView.render().el);
    };
...
define('models/navbar_item',['backbone'], function(Backbone) {
  var NavbarItem;
  return NavbarItem = (function(_super) {
    ...
    NavbarItem.prototype.activateView = function() {
...
define('collections/navbar_items',['views/news/index_view', 'views/fashion/index_view', 'models/navbar_item', 'backbone'], function(NewsView, FashionView, NavbarItem, Backbone) {
  var NavbarItems;
...
define('text!templates/site/page_view.html',[],function () { return '<div class="navbar navbar-inverse navbar-fixed-top"></div>\n<div class="content container">\n  <!-- <div class=\'hero-unit\'> -->\n     <!-- <h2>Sveiki atvyke i centralizuota naujienu hub\'a</h2> -->\n    <!-- <p>Cia rasite karsciausias ir naujausias Lietuvos naujienas</p> -->\n  <!-- </div> -->\n</div>';});
...
define('views/site/page_view',['views/navbar/index_view', 'collections/navbar_items', 'backbone', 'text!templates/site/page_view.html'], function(Navbar, NavbarItems, Backbone, Template) {
  var PageView;
  return PageView = (function(_super) {
    ...
    PageView.prototype.navbar = function() {
    ...
    PageView.prototype.checkForActiveView = function() {
      return this.navItems.each(this.displayActiveView);
    };

    PageView.prototype.displayActiveView = function(model) {
      var View, _ref;
...
define('app',['jquery', 'underscore', 'backbone', 'views/site/page_view', 'bootstrap'], function($, _, Backbone, Page) {
  return {
    init: function() {
      var page;
      page = new Page;
      return $('body').append(page.render().el);
    }
  };
});
